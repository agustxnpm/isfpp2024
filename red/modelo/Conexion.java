...
public class Conexion {
	...
	public Conexion(Equipo equipo1, Equipo equipo2, TipoPuerto tipoPuerto1, TipoPuerto tipoPuerto2, TipoCable tipoCable) {
		super();
	...
	public String toString() {
		return "Conexion [equipo1=" + equipo1 + ", equipo2=" + equipo2 + ", tipoPuerto1=" + tipoPuerto1
