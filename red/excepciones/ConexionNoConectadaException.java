 ...
 */
public class ConexionNoConectadaException  extends RuntimeException {
     ...
     */
    public ConexionNoConectadaException (String message, Throwable cause, boolean enableSuppression,
     ...
     * @param cause La causa de la excepción.
     */
    public ConexionNoConectadaException (String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @param message El mensaje de la excepción.
     */
    public ConexionNoConectadaException (String message) {
        super(message);
    }
     ...
     * @param cause La causa de la excepción.
     */
    public ConexionNoConectadaException (Throwable cause) {
        super(cause);
    }
}
