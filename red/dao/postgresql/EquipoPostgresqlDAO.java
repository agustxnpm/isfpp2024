...
/**
 * Implementación de la interfaz EquipoDAO para manejar las operaciones CRUD
 * de la entidad Equipo utilizando una base de datos PostgreSQL.
 */
public class EquipoPostgresqlDAO implements EquipoDAO {
    ...
    /**
     * Constructor que inicializa los mapas de tipo de equipo, ubicaciones y tipo de puertos.
     * 
     * @throws FileNotFoundException si ocurre un error al cargar los datos.
     */
    ...
    public void actualizar(Equipo equipo) {
        ...
        try {
            ...
            String sql = "UPDATE poo2024.equipos_palma SET descripcion = ?, marca = ?, modelo = ?, tipo_equipo = ?, ubicacion = ?, estado = ?, info_puertos = ? "
                    + "WHERE codigo = ?";
            pstm = con.prepareStatement(sql);
    ...
    public void borrar(Equipo equipo) {
        ...
        try {
            ...
            // Eliminar direcciones IP asociadas al equipo
            String sqlDeleteIp = "DELETE FROM poo2024.direcciones_ip_palma WHERE equipo_codigo = ?";
    ...
    /**
     * Busca y devuelve todos los equipos en la base de datos.
     * 
    ...
    /**
     * Carga todos los tipos de equipos desde la base de datos.
     * 
     * @return Un mapa de tipos de equipos.
     * @throws FileNotFoundException si ocurre un error al cargar los tipos de equipos.
     */
    ...
    /**
     * Carga todos los tipos de puertos desde la base de datos.
     * 
     * @return Un mapa de tipos de puertos.
