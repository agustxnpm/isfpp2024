 ...
 */
public class EquipoNoConectadoException extends RuntimeException {

    /**
     * Constructor sin argumentos que invoca el constructor de la superclase.
     */
    public EquipoNoConectadoException() {
        super();
    }
     ...
     */
    public EquipoNoConectadoException(String message, Throwable cause, boolean enableSuppression,
     ...
     * @param cause La causa de la excepción.
     */
    public EquipoNoConectadoException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @param message El mensaje de la excepción.
     */
    public EquipoNoConectadoException(String message) {
        super(message);
    }
     ...
     * @param cause La causa de la excepción.
     */
    public EquipoNoConectadoException(Throwable cause) {
        super(cause);
    }
}
